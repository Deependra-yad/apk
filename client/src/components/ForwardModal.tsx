    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          {/* Search */}
          <div className="h-10 bg-black/40 rounded-xl px-3 flex items-center gap-2 border border-white/10">
          ...
          <div className="max-h-72 overflow-y-auto space-y-3 no-scrollbar py-1">
            ...
            {filteredGroups.length > 0 && (
              <div className="space-y-1">
                <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider px-1">Groups</span>
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center justify-between p-2 rounded-xl cursor-pointer ${
                        isSelected ? 'bg-liquid-accent/15 border border-liquid-accent/30' : 'hover:bg-white/5'
                      }`}
                    >
            ...
            {/* Contacts */}
            <div className="space-y-1">
              <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider px-1">Contacts</span>
              {filteredUsers.map(u => {
          ...
          <button
            ...
            className="h-11 bg-gradient-to-r from-liquid-accent to-liquid-secondary rounded-xl text-white font-bold text-xs flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(0,210,255,0.4)] hover:brightness-110 disabled:opacity-40"
          >
            <Forward size={16} />
